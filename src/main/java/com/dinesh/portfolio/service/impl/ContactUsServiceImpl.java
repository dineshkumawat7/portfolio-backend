...
public class ContactUsServiceImpl implements ContactUsService {
    ...
    public ContactUsResponseDTO createContactUs(ContactUsRequestDTO contactUsRequestDTO) {
        log.debug("Creating new contact-us request");
        try {
            ...
            log.info("Contact-us request created successfully. id={}", saved.getId());
            return modelMapper.map(saved, ContactUsResponseDTO.class);
        } catch (Exception ex) {
            log.error("Error while creating contact-us request", ex);
            throw new ServiceException("Unable to create contact-us request", ex);
        }
    }
    ...
    public List<ContactUsResponseDTO> getAllContactUsDetails() {
        ...
        try {
            ...
            log.error("Error while fetching contact-us details", ex);
